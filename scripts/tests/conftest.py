"""Shared pytest fixtures for AutomotiveClaw L1 unit tests."""
import os
import sys
...
import pytest
from auto_helpers import init_all_tables, get_conn, build_env


@pytest.fixture
def db_path(tmp_path):
    """Per-test fresh SQLite database with core + automotiveclaw schema."""
...
@pytest.fixture
def env(conn):
    """Full automotive environment: company, accounts, FY, CC, customer, vehicle, supplier."""
